...
- (void)setLoadedHandler:(void (^)(AdConfig *config, BOOL reuslt))handler {
...
- (void)setShownHandler:(void (^)(AdConfig *config))handler {
...
- (void)setClosedHandler:(void (^)(AdConfig *config, BOOL result, BOOL isSkipped))handler {
...
- (void)setClickedHandler:(void (^)(AdConfig *config))handler {
